...
const Reviews = ({ id, mediaType, title, reviews }: IReviewsProps) => {
  ...
  return (
    <>
      <Link href={`${route}/reviews`} className="group flex items-center w-fit">
      ...
      <div className="pt-7">
        <div className="w-[90%] max-md:w-[100%]">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span
                    className={`text-lg text-dark 
                          ${
                            reviews[randomReview].author_details.rating &&
              ...
              <div className="pt-3">
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: reviews[randomReview]?.content,
                  }}
                  className={`max-md:text-sm ${
                    !readMore && showReadMore ? "line-clamp-5" : ""
                  }`}
                />
          ...
          <div
            className="pt-5 font-normal text-main-1 
          ...
          >
            ...
            <p>{reviews[randomReview]?.author_details?.username}</p>
          </div>
        </div>
      </div>
    </>
