    ...
    <div key={id} className="w-full h-36 py-2 flex border-b">
      ...
      <div className="flex-1 flex justify-between">
        <div className="flex flex-col gap-1 ml-4">
          ...
          <Link href={url} className="pt-1">
            <h4
              className="line-clamp-1 text-main max-sm:text-sm
          ...
          <div className="pt-2 flex items-center gap-1">
            ...
            <span
              className={`text-sm text-main-1 ${
                vote > 0 ? "font-semibold" : "font-normal italic"
              }`}
            >
        ...
        <div>
          {releaseDate ? (
            ...
            <p className="text-main-1 italic text-sm ">No date yet</p>
          )}
        </div>
      </div>
    </div>
